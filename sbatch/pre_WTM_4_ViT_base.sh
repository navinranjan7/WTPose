...
#SBATCH --job-name=pre_all_ViT		# Name for your job
...
#SBATCH --time=4-00:30:00		# Time limit
#SBATCH --nodes=1			# How many nodes to run on
#SBATCH --ntasks=4		# How many tasks per node
#SBATCH --cpus-per-task=1		# Number of CPUs per task
#SBATCH --mem-per-cpu=25g		# Memory per CPU
...
python -m torch.distributed.launch \
    ...
    --nproc_per_node=4 \
    tools/train.py \
    configs/body_2d_keypoint/topdown_heatmap/coco/_pre_WTM_4_ViT_base_coco_256x192.py \
    --launcher pytorch ${@:3}
