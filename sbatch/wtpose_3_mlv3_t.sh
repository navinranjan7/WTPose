...
#SBATCH --job-name=WTPose-t_384		# Name for your job
...
#SBATCH --time=8-00:30:00		# Time limit
...
python -m torch.distributed.launch \
    ...
    --nproc_per_node=4 \
    tools/train.py \
    configs/body_2d_keypoint/topdown_heatmap/coco/wtm_mlv3_resnet101_swin_t_w7_coco_384x288.py \
    --launcher pytorch ${@:3}
