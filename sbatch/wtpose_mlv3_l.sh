...
#SBATCH --job-name=WTPose-L		# Name for your job
...
#SBATCH --time=5-00:30:00		# Time limit
...
python -m torch.distributed.launch \
    ...
    --nproc_per_node=4 \
    tools/train.py \
    configs/body_2d_keypoint/topdown_heatmap/coco/wtm_mlv3_resnet101_swin_l_w7-coco_256x192.py \
    --launcher pytorch ${@:3}
