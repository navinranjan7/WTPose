...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 12 23:30:32 2023
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='/home/nr4325/Desktop/Pose4/mmpose/ImageNet_pretrained_model/resnet101_swinv2_b.pth')
    ),
    # neck=dict(
    #     type='WTM_A',
