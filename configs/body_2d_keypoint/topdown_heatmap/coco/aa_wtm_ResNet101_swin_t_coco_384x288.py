...
model = dict(
    type='TopDown2B',
    pretrained_1='torchvision://resnet101',
    pretrained_2='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_tiny_patch4_window7_224.pth',
    backbone_1=dict(type='TOPResNet', depth=101),
    backbone_2=dict(
        type='WTSwin',
        embed_dims=96,
        depths=[2, 2, 6, 2],
