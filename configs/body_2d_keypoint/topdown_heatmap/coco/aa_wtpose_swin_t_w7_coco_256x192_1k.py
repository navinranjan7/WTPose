...
model = dict(
    ...
    backbone=dict(
        ...
        ## WTM_A{
        wtm_in_dim=1440,   # sum of all channels
        wtm_kernel_size = 7,
        wtm_dim=128, 
        wtm_out_dim=128,
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='https://download.openmmlab.com/mmclassification/v0/swin-transformer/convert/swin_base_patch4_window7_224-4670dd19.pth'),
    ),
    # neck=dict(
    #     type='WTM_A',
