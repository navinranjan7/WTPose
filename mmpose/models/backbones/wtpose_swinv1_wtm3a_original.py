...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 22 22:57:55 2023
...
class WTM3D_A(nn.Module):
    ...
    def __init__(self, in_dim, dim, out_dim, window_size, num_heads, dilations, stride, size, low_level_dim, reduction):
        ...
        self.wtb1_0 = WaterfallTransformerLayer3D(1, num_heads = num_heads[0], window_size=window_size, dilation = dilations[0], stride=stride)
        self.wtb1_1 = WaterfallTransformerLayer3D(1, num_heads = num_heads[0], window_size=window_size, dilation = dilations[1], stride=stride)

        self.wtb2_0 = WaterfallTransformerLayer3D(1, num_heads = num_heads[1], window_size=window_size, dilation = dilations[2], stride=stride)
        self.wtb2_1 = WaterfallTransformerLayer3D(1, num_heads = num_heads[1], window_size=window_size, dilation = dilations[3], stride=stride)

        self.wtb3_0 = WaterfallTransformerLayer3D(1, num_heads = num_heads[2], window_size=window_size, dilation = dilations[4], stride=stride)
        self.wtb3_1 = WaterfallTransformerLayer3D(1, num_heads = num_heads[2], window_size=window_size, dilation = dilations[5], stride=stride)

        self.wtb4_0 = WaterfallTransformerLayer3D(1, num_heads = num_heads[3], window_size=window_size, dilation = dilations[6], stride=stride)
        self.wtb4_1 = WaterfallTransformerLayer3D(1, num_heads = num_heads[3], window_size=window_size, dilation = dilations[7], stride=stride)
