...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 30 09:57:41 2023
...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug 26 15:28:31 2023
...
#         self.conv2 = nn.Conv2d(64, embed_dims, kernel_size=3, stride=2, padding=1, bias=False)
...
class WTPoseSwinV2(BaseBackbone):
    """Swin Transformer V2.
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(WTPoseSwinV2, self).__init__(init_cfg=init_cfg)
        ...
        _resnet_cfg = {
            ...
            'out_indices': self.resnet_out_indices,
            'hw_shape': self.hw_shape
            }
        self.resnet = ResNet(**_resnet_cfg)
        ...
        # _stem_cfg = {
        #     'embed_dims':embed_dims[-1]}   
        # self.stem = Stem(**_stem_cfg)

    def init_weights(self):
        super(WTPoseSwinV2, self).init_weights()
    ...
    def forward(self, x):
        ...
        # print('1: Checking hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh')
        # print(resnet_out.size())
        # print(resnet_out.size())
        hw_shape = x.shape[2], x.shape[3]
        x = self.conv3(x)
        x = self.bn3(x)
    ...
    def train(self, mode=True):
        super(WTPoseSwinV2, self).train(mode)
        self._freeze_stages()
