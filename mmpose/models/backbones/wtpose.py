...
class WTPose(BaseBackbone):
    ...
    def __init__(self,
        ...
        super(WTPose, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self, pretrained=None):
        ...
        if (isinstance(self.init_cfg, dict)
            ...
            super(WTPose, self).init_weights()
            if self.use_abs_pos_embed:
