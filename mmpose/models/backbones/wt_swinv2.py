...
class wtSwinV2(BaseBackbone):
    ...
    def __init__(self,
        ...
        super(wtSwinV2, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        super(wtSwinV2, self).init_weights()
    ...
    def train(self, mode=True):
        super(wtSwinV2, self).train(mode)
        self._freeze_stages()
        if mode and self.norm_eval:
            for m in self.modules():
                # trick: eval have effect on BatchNorm only
