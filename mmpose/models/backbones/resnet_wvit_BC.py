...
class UpSample(nn.Module):
    def __init__(self, in_channels=768, out_channels=128, ratio=1, norm_cfg=None):
        ...
        self.upsample_1 = nn.Sequential(
            ...
            nn.Conv2d(in_channels, hidden_features, kernel_size=3, stride=1, padding=1),
        ...
        self.upsample_2 = nn.Sequential(
            nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True),
            nn.Conv2d(hidden_features, out_channels, kernel_size=3, stride=1, padding=1),
...
class ResnetWViTBC(BaseBackbone):
    ...
    def __init__(self,
                 ...
                 pre_norm=False,
                 init_cfg=None):
        super(ResnetWViTBC, self).__init__(init_cfg)
    ...
    def init_weights(self):
        super(ResnetWViTBC, self).init_weights()
