...
class HeatmapHeadWTPose(BaseHead):
    ...
    def forward(self, feats: Tuple[Tensor]) -> Tensor:
        ...
        # print(f'head_feats: {x.size()}')
        x = self.conv_layers(x)
        # print(f'head_conv:{x.size()}')
    ...
    def loss(self,
        ...
        # print(f'gt_heatmaps shape: {gt_heatmaps.shape}')
        # print(f'keypoint_weights shape: {keypoint_weights.shape}')
        # calculate losses
        losses = dict()
